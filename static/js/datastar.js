...
), Nt = (t, e) => Object.keys(e).forEach((s) => t[s].value = e[s]), Ee = (t, { peek: e = !1 } = {}) => Object.entries(t).reduce(
...
const jt = /* @__PURE__ */ new Set(["window", "once", "passive", "capture", "debounce", "throttle", "remote", "outside"]), Ut = {
  ...
  onLoad: (t) => {
    ...
    if (i) {
      const d = _e(i), v = se(i, "leading", !1), u = se(i, "noTrail", !0);
      o = Jt(o, d, v, u);
    }
    const f = t.modifiers.get("throttle");
    if (f) {
      const d = _e(f), v = se(f, "noLead", !0), u = se(f, "noTrail", !1);
      o = Kt(o, d, v, u);
    }
    const l = {
      capture: !0,
